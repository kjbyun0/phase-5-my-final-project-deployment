...
Revision ID: 6826e4c66b0b
Revises: 
Create Date: 2024-05-06 20:34:09.431806
...
def upgrade():
    ...
    sa.Column('_User__password_hash', sa.String(), nullable=False),
    ...
    sa.Column('in_types', sa.String(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['item_id'], ['items.id'], name=op.f('fk_subitems_item_id_items')),
    sa.PrimaryKeyConstraint('id')
    )
